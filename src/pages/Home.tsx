...
export default function Home() {
  ...
  return (
    <>
      ...
      <div>
        {/* Title */}
        <h2 className="mx-2 mt-4 text-center text-[#0A2C22] lg:text-lg">
        ...
        {/* Text 2 Img*/}
        <div className="flex items-center gap-8 mt-8 mx-2 text-sm text-justify text-[#0D3C2F] lg:w-3/4 lg:mx-auto lg:text-base">
        ...
        {/* Text 1 Img */}
        <div className="flex items-center gap-8 mx-2 mt-8 text-sm text-justify text-[#0D3C2F] lg:w-3/4 lg:mx-auto lg:text-base">
          <div className="w-1/3 mx-auto">
